...
const GET_SPECS_DESCRIPTION =
  "Get the schema for a specific Quill format. Returns { schema } where schema is TOON-encoded (token-efficient for LLM consumption) and includes an `example` field with a fully-authored reference document when the quill provides one.";
